...
using Google.Solutions.IapDesktop.RemoteDesktop;
...
namespace Google.Solutions.IapDesktop.Windows
{
    ...
    {
        private readonly JobService jobService = Program.Services.GetService<JobService>();
        private readonly IEventService eventService = Program.Services.GetService<IEventService>();
        private readonly RemoteDesktopService rdpService = Program.Services.GetService<RemoteDesktopService>();
