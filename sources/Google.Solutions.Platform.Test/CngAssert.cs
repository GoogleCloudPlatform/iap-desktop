...
{
    /// <summary>
    /// Assertions for dealing with CNG keys.
    /// </summary>
    internal class CngAssert
    {
        public static void AssertEqual(CngAlgorithm algorithm, CngKey lhs, CngKey rhs)
        {
        ...
        public static void AssertNotEqual(CngAlgorithm algorithm, CngKey lhs, CngKey rhs)
        {
            if (algorithm == CngAlgorithm.Rsa)
            {
                var lhsParams = new RSACng(lhs).ExportParameters(false);
