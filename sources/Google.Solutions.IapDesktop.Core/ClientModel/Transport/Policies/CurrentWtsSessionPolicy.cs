...
{
    /// <summary>
    /// Policy that only allows access from the current WTS session.
    /// </summary>
    public class CurrentWtsSessionPolicy : ProcessPolicyBase
    {
        //---------------------------------------------------------------------
        // Overrides.
        //---------------------------------------------------------------------

        public override string Name => "Current WTS session";
