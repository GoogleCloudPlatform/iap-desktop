...
namespace Google.Solutions.IapDesktop.Extensions.Shell.Test.Services.Tunnel
{
    ...
    public class TestTunnelBrokerService : ShellFixtureBase
    {
        ...
        public async Task WhenConnectSuccessful_ThenOpenTunnelsIncludesTunnel()
        {
            ...
            mockEventService.Setup(s => s.PublishAsync(It.IsAny<TunnelOpenedEvent>()))
        ...
        public async Task WhenConnectSuccessful_OpenEventIsFired()
        {
            ...
            mockEventService.Verify(s => s.PublishAsync(It.IsAny<TunnelOpenedEvent>()), Times.Once);
        }
        ...
        public async Task WhenClosingTunnel_CloseEventIsFired()
        {
            ...
            mockEventService.Setup(s => s.PublishAsync(It.IsAny<TunnelOpenedEvent>()))
                .Returns(Task.FromResult(true));
            mockEventService.Setup(s => s.PublishAsync(It.IsAny<TunnelClosedEvent>()))
                .Returns(Task.FromResult(true));
            ...
            mockEventService.Verify(s => s.PublishAsync(It.IsAny<TunnelClosedEvent>()), Times.Once);
        }
