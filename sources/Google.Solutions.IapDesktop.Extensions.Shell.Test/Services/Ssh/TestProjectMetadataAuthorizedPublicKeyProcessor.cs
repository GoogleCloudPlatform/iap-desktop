...
{
    [TestFixture]
    public class TestProjectMetadataAuthorizedPublicKeyProcessor : ApplicationFixtureBase
    {
        ...
        [Test]
        public async Task WhenProjectHasExpiredKeys_ThenRemoveAuthorizedKeyLeavesThemAsIs()
        {
            await Task.Yield();
            Assert.Fail();
        }
