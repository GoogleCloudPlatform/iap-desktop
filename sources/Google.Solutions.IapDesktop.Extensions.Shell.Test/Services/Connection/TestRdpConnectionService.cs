...
//        [Test]
//        public async Task __WhenConnectingByNodeAndPersistentCredentialsDisallowed_ThenPasswordIsClear()
//        {
...
//        [Test]
//        public async Task __WhenConnectingByNodeAndPersistentCredentialsAllowed_ThenCredentialsAreUsed()
//        {
//            var settings = InstanceConnectionSettings.CreateNew("project", "instance-1");
//            settings.RdpUsername.Value = "existinguser";
//            settings.RdpPassword.Value = SecureStringExtensions.FromClearText("password");
...
//        [Test]
//        public async Task __WhenConnectingByUrlWithoutUsernameAndNoCredentialsExist_ThenConnectionIsMadeWithoutUsername()
//        {
//            var settingsService = new Mock<IConnectionSettingsService>();
...
//        [Test]
//        public async Task __WhenConnectingByUrlWithUsernameAndNoCredentialsExist_ThenConnectionIsMadeWithThisUsername()
//        {
//            var settingsService = new Mock<IConnectionSettingsService>();
