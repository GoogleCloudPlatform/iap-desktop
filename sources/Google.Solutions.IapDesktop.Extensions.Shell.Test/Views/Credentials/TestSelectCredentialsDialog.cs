...
{
    [TestFixture]
    public class TestSelectCredentialsDialog : ShellFixtureBase
    {
        ...
        private ISelectCredentialsDialog CreateCredentialsPrompt(
            ...
            Mock<ITaskDialog> taskDialogMock)
        {
            ...
            var credentialsService = this.serviceRegistry.AddMock<INewCredentialsDialog>();
            credentialsService.Setup(s => s.ShowDialogAsync(
            ...
            [Values(true, false)] bool isGrantedPermissionToGenerateCredentials)
        {
            ...
            await credentialPrompt
                .SelectOrCreateCredentialsAsync(
                    null,
                    SampleInstance,
                    settings,
                    true)
        ...
        public void WhenNoCredentialsFoundAndPermissionNotGrantedAndBehaviorSetToAllowIfNoCredentialsFound_ThenJumpToSettingsOptionIsShown()
        {
            ...
            ExceptionAssert.ThrowsAggregateException<TaskCanceledException>(
                () => credentialPrompt.SelectOrCreateCredentialsAsync(
                null,
                SampleInstance,
                settings,
                true).Wait());
