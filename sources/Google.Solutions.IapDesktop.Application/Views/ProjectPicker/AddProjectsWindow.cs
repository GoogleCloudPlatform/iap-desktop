...
{
    /// <summary>
    /// Project picker for adding a project.
    /// </summary>
    public interface IAddProjectsWindow : IDisposable
    {
    ...
    public class AddProjectsWindow : ProjectPickerWindow, IAddProjectsWindow
    {
