...
{
    [TestFixture]
    public class TestQwordValueAccessor : TestValueAccessorBase<long>
    {
        ...
        private protected override ValueAccessor<long> CreateAccessor(string valueName)
        {
            return new QwordValueAccessor(valueName);
        }
    }
}
