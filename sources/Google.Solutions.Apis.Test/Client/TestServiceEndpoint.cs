...
namespace Google.Solutions.Apis.Test.Client
{
    ...
    public class TestServiceEndpoint
    {
            ...
            DeviceEnrollmentState state)
        {
            ...
            Assert.That(
                details.BaseUri,
                Is.EqualTo(new Uri("https://sample.googleapis.com/compute")));
        ...
        public void GetDirections__WhenMtlsEnabled_ThenReturnsMtlsEndpoint()
        {
            ...
            Assert.That(
                details.BaseUri,
                Is.EqualTo(new Uri("https://sample.mtls.googleapis.com/compute")));
            ...
            DeviceEnrollmentState state)
        {
            ...
            Assert.That(
                details.BaseUri,
                Is.EqualTo(new Uri("https://sample.p.Googleapis.COM/compute")));
        ...
        public void ToString_ContainsUri()
        {
            ...
            Assert.That(
                endpoint.ToString(),
                Does.Contain("https://sample.googleapis.com/compute"));
        }
    }
}
